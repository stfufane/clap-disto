...
, mPreFilter(disstortion, params::ePreFilterFreq, RotaryKnob::Mapping::Logarithmic)
, mPostFilter(disstortion, params::ePostFilterFreq, RotaryKnob::Mapping::Logarithmic)
